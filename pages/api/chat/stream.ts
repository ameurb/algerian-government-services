...
import { handleMultilingualChat } from '@/lib/multilingual-handler';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // Get response from multilingual SQLite database with 3 language collections
    const chatResult = await handleMultilingualChat(message, sessionId, userId);
